...
$.ajax({
	type : "GET",
	// url:'/Home/Index/ajaxGetPrice?goods_id='+goodsId,
	url:"<?php echo U('/Home/Index/ajaxGetPrice?goods_id='.$info['id']);?>",
	// data:{'goods_id':goodsId},
	dataType:'json',
	// url : "<?php echo U('Home/Index/ajaxGetPrice'); ?>/goods_id/"+goodsId,
	headers:{'X_UA':'asdfgghhhhhhhhhhhhhh'},
	success : function(res)
	{
		if(res.err == 0){
			// 把会员价格放到页面中
			$("#memberprice").html('￥ '+res.memberprice+' 元');
		}
	}
});
// ajax获取商品的评论框
$.ajax({
	type :"GET",
	url:"/Home/Index/ajaxGetComment?goods_id="+goodsId,
	// url : "<?php echo U('/Home/Index/ajaxGetComment'); ?>/goods_id/"+goodsId,
	dataType : "json",
